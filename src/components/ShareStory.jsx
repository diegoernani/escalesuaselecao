...
function ShareArrowIcon() {
  return (
    <svg width="56" height="56" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path d="M10 6L17 6L17 13" stroke="#FACC15" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M17 7L7.5 16.5" stroke="#FACC15" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M14.5 17.5H7.5V10.5" stroke="#FACC15" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function LogoMark() {
  return (
    <svg width="76" height="76" viewBox="0 0 76 76" fill="none" aria-hidden="true">
      <circle cx="38" cy="38" r="32" fill="#FACC15" />
      <path d="M27 26.5L33.5 22H42.5L49 26.5V49.5L43.5 53H32.5L27 49.5V26.5Z" fill="#03123D" />
      <path d="M31 26H45" stroke="#03123D" strokeWidth="3" strokeLinecap="round" />
      <path
        d="M38 30L39.6 33.3L43.2 33.8L40.6 36.3L41.2 39.9L38 38.2L34.8 39.9L35.4 36.3L32.8 33.8L36.4 33.3L38 30Z"
        fill="#FACC15"
      />
    </svg>
  );
